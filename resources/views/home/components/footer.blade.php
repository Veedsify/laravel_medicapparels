  ...
  <footer class="footer footer_type_1">
      <div class="footer-middle container">
          <div class="row row-cols-lg-5 row-cols-2">
              <div class="footer-column footer-store-info mb-4 mb-lg-0">
                  ...
                  <p class="footer-address">Hello World Address</p>
              ...
              <div class="footer-column footer-menu mb-4 mb-lg-0">
                  ...
                  <ul class="sub-menu__list list-unstyled">
                      ...
                      <li class="sub-menu__item"><a href="" class="menu-link menu-link_us-s">Privacy Policy</a>
                      </li>
                      <li class="sub-menu__item"><a href="/terms/" class="menu-link menu-link_us-s">Terms Of Service</a>
                      </li>
                      <li class="sub-menu__item"><a href="/user/" class="menu-link menu-link_us-s">My Account</a></li>
                  </ul>
              </div><!-- /.footer-column -->
              <div class="footer-column footer-menu mb-4 mb-lg-0">
                  <h5 class="sub-menu__title text-uppercase">More Info</h5>
                  <ul class="sub-menu__list list-unstyled">
                      <li class="sub-menu__item"><a href="shop2.html" class="menu-link menu-link_us-s">Shipping &
                              Returns</a>
                      </li>
                      <li class="sub-menu__item"><a href="/contact" class="menu-link menu-link_us-s">Contact Us</a>
                      </li>
                      <li class="sub-menu__item"><a href="/order/track" class="menu-link menu-link_us-s">Track an
                              Order</a>
                      </li>
                      <li class="sub-menu__item"><a href="shop4.html" class="menu-link menu-link_us-s">Look Book</a>
                      </li>
                  </ul>
              </div><!-- /.footer-column -->
              <div class="footer-column footer-newsletter mb-4 mb-lg-0">
                  <h5 class="sub-menu__title text-uppercase">Support & Updates</h5>
      ...
      <div class="footer-bottom container">
          <div class="d-block d-md-flex align-items-center">
              <span class="footer-copyright me-auto">©{{ date('Y') }} Medicapparels</span>
