        ...
        <div class="container">
            <div class="overflow-hidden">
                <ul class="navigation__list list-unstyled position-relative">
                    ...
                    <li class="navigation__item">
                        <a href="/shop" class="navigation__link js-nav-right d-flex align-items-center">Shop</a>
                    </li>
                    <li class="navigation__item">
                        <a href="/blog" class="navigation__link js-nav-right d-flex align-items-center">Blog</a>
                    </li>
                    <li class="navigation__item">
                        <a href="/about" class="navigation__link js-nav-right d-flex align-items-center">About US</a>
                    </li>
                    <li class="navigation__item">
                        <a href="/contact" class="navigation__link js-nav-right d-flex align-items-center">Contact
                            Us</a>
                    </li>
                    <li class="navigation__item">
                        <a href="/size-chart" class="navigation__link js-nav-right d-flex align-items-center">Size
                            Chart</a>
                    </li>
                </ul><!-- /.navigation__list -->
            </div><!-- /.overflow-hidden -->
        ...
        <div class="border-top mt-auto pb-2">
            <div class="customer-links container mt-4 mb-2 pb-1">
                ...
                <span class="d-inline-block ms-2 text-uppercase align-middle fw-medium">
                    <a href="/user" class="text-dark">My Account</a> </span>
            </div>
        ...
        <div class="header-desk header-desk_type_1">
            ...
            <nav class="navigation">
                <ul class="navigation__list list-unstyled d-flex">
                    ...
                    <li class="navigation__item">
                        <a href="contact.html" class="navigation__link">Size Chart</a>
                    </li>
                </ul><!-- /.navigation__list -->
            </nav><!-- /.navigation -->
            ...
            <div class="header-tools d-flex align-items-center">
                ...
                <a class="header-tools__item" href="/user/wishlist">
                    <svg width="20" height="20" viewbox="0 0 20 20" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
